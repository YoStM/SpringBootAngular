package fr.ystm.server.service.implementation;
...
import fr.ystm.server.service.IServerService;
...
public class ServerServiceImpl implements IServerService {
    ...
    private final IServerRepository serverRepo;
    ...
    @Override
    public Collection<Server> getServersList(int limit) {
